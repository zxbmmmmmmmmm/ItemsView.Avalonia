...
public class WrapLayout : VirtualizingLayout, IOrientationBasedMeasures, IFlowLayoutAlgorithmDelegates
{
    ...
    public static readonly StyledProperty<double> MinColumnSpacingProperty =
        AvaloniaProperty.Register<WrapLayout, double>(nameof(MinColumnSpacing));

    public static readonly StyledProperty<double> MinRowSpacingProperty = 
        AvaloniaProperty.Register<WrapLayout, double>(nameof(MinRowSpacing));

    public static readonly StyledProperty<Orientation> OrientationProperty =
        StackPanel.OrientationProperty.AddOwner<WrapLayout>();
    ...
    protected internal override void InitializeForContextCore(VirtualizingLayoutContext context)
    {
        ...
        WrapLayoutState flowState = null;
        if (state != null)
        {
    ...
    private WrapLayoutState GetAsFlowState(object state) =>
        state as WrapLayoutState;
    ...
    private double GetAverageLineInfo(Size availableSize, VirtualizingLayoutContext context,
        WrapLayoutState flowState, ref double avgCountInLine)
    {
